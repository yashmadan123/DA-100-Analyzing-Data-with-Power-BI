...
4. In the **Open** window, navigate to the **D:\DA-100-Allfiles\Labs\09-create-power-bi-dashboard\Solution** folder.
...
7. In the **Save As** window, navigate to the **D:\DA-100-Allfiles\MySolution** folder.
