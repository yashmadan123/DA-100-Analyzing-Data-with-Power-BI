...
1. In the **Open** window, navigate to the **D:\DA-100-Allfiles\Labs\02-load-data-with-power-query-in-power-bi-desktop\Starter** folder.
...
8. For your convenience, you can copy the expression from the **D:\DA-100-Allfiles\Labs\load-data-with-power-query-in-power-bi-desktop\Assets\Snippets.txt** file.
