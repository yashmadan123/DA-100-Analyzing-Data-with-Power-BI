...
8. In the **Open** window, navigate to the **C:\AllFiles\DA-100-Analyzing-Data-with-Power-BI-prod\Allfiles\DA-100-Allfiles\Labs\08-design-report-in-power-bi-desktop-enhanced\Starter** folder.
