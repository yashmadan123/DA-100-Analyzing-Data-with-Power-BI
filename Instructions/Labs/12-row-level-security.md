...
1. In the **Open** window, navigate to the **D:\DA-100-Allfiles\Labs\12-row-level-security\Starter** folder.
...
1. In the **Save As** window, navigate to the **D:\DA-100-Allfiles\MySolution** folder.
